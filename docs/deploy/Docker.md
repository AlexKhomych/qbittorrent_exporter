...
docker run -dit --name qbittorrent_exporter \
    ...
    alexkhomychw/qbittorrent_exporter:1.0.2
```
...
```bash
docker run -dit --name qbittorrent_exporter -p 17171:17171 -v ./config:/app/config alexkhomychw/qbittorrent_exporter:1.0.2
```
